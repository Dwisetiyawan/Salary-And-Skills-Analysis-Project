...
The focus of this analysis is to know what skills needed to become a data analyst, skills vs salary correlation, and th median salary of top ten skills.
...
The objective of the chart above is to show median salary of each skill that mentioned on the job postings. SQL, Excel, Python, and Tableau as the most mentioned skills for data analyst job has median salary USD 92,500 , USD 84,500 , USD 98,500 , and USD 95,000 respectively. Python has the highest median salary, however, it is likely to be needed for more data scientist or data engineer role. 
...
- Pivot Table & DAX
    ...
    1. Pivot Table : created a PivotTable using the Data Model created before with Power Pivot, moved the job_title_short to the rows area and salary_year_avg into the values area
